      ...
      <div className="relative w-full">
        ...
        <div className="w-full h-[90vh] overflow-visible">
          <div className="h-full relative">
            <Image src={"/images/social1.png"} alt="viral_image" fill objectFit="cover" objectPosition="top"/>
          </div>
        </div>
        ...
        <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-between">
          <div className="mt-[100px] flex flex-col items-center justify-start whitespace-pre-wrap">
            <h1 className="text-[60px] font-[700] text-center leading-normal">마케팅의 모든것<br/>토스에서 쉽고 간편하게</h1>
