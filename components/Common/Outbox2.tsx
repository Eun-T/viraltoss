...
const Outbox2 = ({ isOpen, setOpen }: Outbox) => {
  ...
  return isOpen ? (
    <div className="fixed px-[20px] s:px-[30px] w-full h-full top-0 left-0 z-[100] flex justify-center items-center">
      ...
      >
        <div
          className="absolute top-[33px] s:top-[25px] z-[300] right-[30px] cursor-pointer"
          onClick={() => {
            setOpen(false);
          }}
        >
        ...
        <div className="l:max-w-[60%]">
          <div className="break-keep">
            ...
            <h5 className="mb-[10px] l:mb-[5px]">
              파워링크와 스마트플레이스는 네이버 마케팅에서 필수적인 구성
              요소입니다.
              <br />
              엄청난 효과를 내기보다는 브랜드 이미지와 전문성을 강조할 수 있기에
            ...
            <h5 className="mb-[10px] l:mb-[7px]">
              - 고객님의 음식점/회사를 홍보하기 위해서는 그 성격에 맞는 키워드를
              적어야합니다. 그렇지 않으면 파워링크의 경우 상당한 광고비용을
              지불해야 되고 스마트플레이스의 경우에는 순위하락으로
              이어집니다.&nbsp;
              <span className="text-green-600">
                키워드 선택과 함께 이미지와 홍보 문구 등
              </span>
            ...
            <h5 className="">
              - 파워링크/스마트플레이스 전부 세팅하기 위해서 설정할 수 있는
              ...
              고객님에 맞는 세팅을 설정해주고 이전에 알지 못한 유용한 팁을
              공유합니다.
              <br />
